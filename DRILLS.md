# SDE-2 Pattern Drill List

A comprehensive practice schedule to master all 16 SDE-2 patterns.
Target: Solve 4-5 problems per topic to handle every variation.
