...
| **High** | **Strings**      | [Reverse Words using Stack](src/main/java/com/dsa/stack/EvaluateReversePolishNotation.java) (closest match), String Compression                                                   |
...
| Priority | Pattern     | Question / Link                                                                             |
| :------- | :---------- | :------------------------------------------------------------------------------------------ |
| **High** | **DP**      | [Coin Change](src/main/java/com/dsa/dp/CoinChange.java), Maximize Score                     |
| **High** | **Heaps**   | [Task Scheduler](src/main/java/com/dsa/heaps/TaskScheduler.java), Rearrange String          |
...
| Priority | Pattern                      | Question / Link                                                                                                                  |
| :------- | :--------------------------- | :------------------------------------------------------------------------------------------------------------------------------- |
| **High** | **Design / Data Structures** | [LRU Cache](src/main/java/com/dsa/design/LRUCache.java), Time Based Key-Value Store                                              |
...
| Priority | Pattern           | Question / Link                                                                                                                         |
| :------- | :---------------- | :-------------------------------------------------------------------------------------------------------------------------------------- |
| **High** | **Topo Sort**     | [Course Schedule II](src/main/java/com/dsa/graphs/CourseScheduleII.java), Build Order                                                   |
...
| Priority | Pattern                   | Question / Link                                                                                                                                                   |
| :------- | :------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **High** | **Graph (Shortest Path)** | [Network Delay Time](src/main/java/com/dsa/graphs/NetworkDelayTime.java), Bus Routes                                                                              |
...
| Priority | Pattern      | Question / Link                                                                                     |
| :------- | :----------- | :-------------------------------------------------------------------------------------------------- |
| **High** | **Design**   | Design Snake Game, [Design Leaderboard](src/main/java/com/dsa/design/DesignLeaderboard.java) (mock) |
| **High** | **HashMaps** | Rank Teams by Votes, [Group Anagrams](src/main/java/com/dsa/arrays/GroupAnagrams.java)              |
...
| Priority | Pattern    | Question / Link                                                                                        |
| :------- | :--------- | :----------------------------------------------------------------------------------------------------- |
| **High** | **Arrays** | [Subarray Sum Equals K](src/main/java/com/dsa/arrays/SubarraySum.java), Merge Sorted Array             |
| **High** | **Graphs** | [Number of Islands](src/main/java/com/dsa/graphs/NumberOfIslands.java), Shortest Path in Binary Matrix |
| **High** | **Trees**  | [Diameter of Binary Tree](src/main/java/com/dsa/trees/DiameterOfBinaryTree.java), BST to Circular DLL  |
...
| Priority | Pattern      | Question / Link                                                                |
| :------- | :----------- | :----------------------------------------------------------------------------- |
| **High** | **Design**   | [LRU Cache](src/main/java/com/dsa/design/LRUCache.java), In-Memory File System |
| **High** | **Grouping** | [Group Anagrams](src/main/java/com/dsa/arrays/GroupAnagrams.java)              |
| **Med**  | **Stacks**   | Max Stack, Basic Calculator                                                    |
...
| Priority | Pattern          | Question / Link                                                                                                                                                        |
| :------- | :--------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **High** | **Arrays**       | [Two Sum](src/main/java/com/dsa/arrays/TwoSum.java) (if exists, else 3Sum), [Product of Array Except Self](src/main/java/com/dsa/arrays/ProductOfArrayExceptSelf.java) |
...
| Priority | Pattern    | Question / Link                                                                                |
| :------- | :--------- | :--------------------------------------------------------------------------------------------- |
| **High** | **Trees**  | [Symmetric Tree](src/main/java/com/dsa/trees/SymmetricTree.java), Path Sum                     |
...
| Priority | Pattern          | Question / Link                                                                                                                                    |
| :------- | :--------------- | :------------------------------------------------------------------------------------------------------------------------------------------------- |
| **High** | **Linked Lists** | Add Two Numbers II, Intersection of Two Linked Lists                                                                                               |
...
| Priority | Pattern       | Question / Link                                 |
| :------- | :------------ | :---------------------------------------------- |
| **High** | **Recursion** | Nested List Weight Sum, Max Depth of N-ary Tree |
| **High** | **Design**    | Max Stack, Retain Best Cache                    |
| **High** | **Graphs**    | Find the Celebrity                              |
...
| **Med**  | **Graph**        | [Alien Dictionary](src/main/java/com/dsa/graphs/AlienDictionary.java)                                                                   |
...
| Priority | Pattern     | Question / Link                                                        |
| :------- | :---------- | :--------------------------------------------------------------------- |
| **High** | **Design**  | Design Hit Counter, KV Store                                           |
| **High** | **Graph**   | Evaluate Division                                                      |
